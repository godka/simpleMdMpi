...
int main(int argc, char* argv[])
{
    ...
    if (numprocs == 1){
        ...
        FILE* fout = fopen("record-series.txt", "w+b");
        for (int times = 0; times < TIMES; times++){
            for (int i = 0; i < N; i++)
            {
                fprintf(fout, "step %4d-1: %4d %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f\n",
                    times, i, r[i][0], r[i][1], r[i][2], v[i][0], v[i][1], v[i][2], a[i][0], a[i][1], a[i][2]);
            }
            computeAccelerations(0, 0, N - 1);
            for (int i = 0; i < N; i++) {
                for (int k = 0; k < 3; k++) {
            ...
            for (int i = 0; i < N; i++)
            {
                fprintf(fout, "step %4d-2: %4d %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f\n",
                    times, i, r[i][0], r[i][1], r[i][2], v[i][0], v[i][1], v[i][2], a[i][0], a[i][1], a[i][2]);
            }
            computeAccelerations(0, 0, N - 1);
            for (int i = 0; i < N; i++)
            {
                fprintf(fout, "step %4d-3: %4d %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f\n",
                    times, i, r[i][0], r[i][1], r[i][2], v[i][0], v[i][1], v[i][2], a[i][0], a[i][1], a[i][2]);
            }
            for (int i = 0; i < N; i++){
                for (int k = 0; k < 3; k++){
    ...
    if (myid == 0){
        ...
        FILE* fout = fopen("record.txt", "w+b");
